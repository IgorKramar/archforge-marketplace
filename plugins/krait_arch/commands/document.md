...
If no decision summary exists, refuse and ask the user to run `/krait_arch:decide` first.
...
- Suggestion: "Once this is implemented, run `/krait_arch:review` against the changed code."
