...
For decisions you haven't made yet, use the full `/krait_arch:cycle` instead.
...
1. **Find the next ADR number** by listing `docs/architecture/decisions/`. If `docs/architecture/` doesn't exist, suggest running `/krait_arch:init` first.
