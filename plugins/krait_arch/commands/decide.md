...
If no design doc exists, run `/krait_arch:design` first. Don't decide on a vacuum.
...
Suggest: "Run `/krait_arch:document \"<problem>\"` to write the ADR and update ARCHITECTURE.md."
