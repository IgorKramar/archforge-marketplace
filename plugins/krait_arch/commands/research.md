...
Run after `/krait_arch:discover` and before `/krait_arch:design` when the discovery surfaced any of:
...
- Suggestion: "When the design phase runs, it will read this research as primary input. Run `/krait_arch:design \"<problem>\"` next."
...
3. Suggest: "Re-run `/krait_arch:discover` with this new information, or amend the existing discovery document with a 'Round 2 (post-research)' section."
